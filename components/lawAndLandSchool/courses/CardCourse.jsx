  ...
  return (
    <div className={`w-full h-[20rem] flex items-center justify-between flex-col rounded-2xl overflow-hidden shadow-md bg-white ${style.card_course}`}>
      ...
      <div className='w-full flex items-center justify-end'>
        <button className='text-bluelight text-sm res3:text-xs flex items-center p-4 [&>svg]:hover:mr-4'>موارد بیشتر  <BsChevronLeft className='mr-1 transition-all duration-400' /></button>
      </div>
    </div>
  )
}
